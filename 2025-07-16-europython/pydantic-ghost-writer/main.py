...
A Model Context Protocol server that provides content generation tools
...
@server.tool()
async def generate_blog_post_tool(topic: str, user_prompt: str = "", reference_links: list[str] = None) -> str:
    """
